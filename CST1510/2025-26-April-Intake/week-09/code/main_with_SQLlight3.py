...
def add_to_cart(product_id, quantity):
    ...
    cursor.execute("SELECT productName, price, stock FROM Products WHERE productID = ?", (product_id,))
    ...
    cursor.execute(
        "INSERT INTO CartTransactions (productID, quantity, totalPrice) VALUES (?, ?, ?)",
