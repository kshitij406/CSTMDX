...
# Define the SQL query to select only productName and price columns from the Products table
...
# Note: This script retrieves only product names and prices from the Products table in the "shop" database.
